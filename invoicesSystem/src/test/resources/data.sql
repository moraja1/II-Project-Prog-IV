INSERT INTO `projectii`.`user` (`natural_id`, `password`, `name`, `last_name`, `mobile`, `email`, `enabled`, `type`,
                                `role`)
VALUES ('202220222', 'oW0kAA91qF', 'Dana', 'Lisett', '9636350406', 'dlisett0@intel.com', true, 'Physical', 'Supplier');
INSERT INTO `projectii`.`user` (`natural_id`, `password`, `name`, `last_name`, `mobile`, `email`, `enabled`, `type`,
                                `role`)
...
VALUES ('404440444', 'aU6L3Lc', 'Minni', 'Lepiscopio', '6203604625', 'mlepiscopio2@usa.gov', true, 'Physical',
        'Supplier');
INSERT INTO `projectii`.`user`
    (`natural_id`, `password`, `name`, `last_name`, `mobile`, `email`, `enabled`, `type`,
                                `role`)
